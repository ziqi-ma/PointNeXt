...
"""
THIS IS FOR EVALUATION ON THE SAME OBJ CATEGORIES BUT FORM OBJAVERSE
"""
import argparse
import yaml
import os
...
from openpoints.dataset import build_dataloader_from_cfg, get_class_weights, get_features_by_keys, ShapeNetPartObjaverse, ShapeNetPartNormal
...
def main(gpu, cfg):
    ...
    print(val_loader.dataset.cls2parts)
